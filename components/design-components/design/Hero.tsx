...
import { File, Home, PlusSquare, Search } from "lucide-react";
...
export const BackgroundCircles = ({ parallaxRef }: { parallaxRef?: any }) => {
  ...
  return (
    <div className="absolute -z-30 -top-[42.375rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[32rem]">
      <Rings />
